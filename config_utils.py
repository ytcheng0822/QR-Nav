...
def hm3d_config(path:str=HM3D_CONFIG_PATH,stage:str='val',episodes=1000):
    ...
    with read_write(habitat_config):
        ...
        habitat_config.habitat.simulator.scene_dataset = SCENE_PREFIX + "/hm3d/hm3d_annotated_basis.scene_dataset_config.json"
...
def mp3d_config(path:str=MP3D_CONFIG_PATH,stage:str='val',episodes=1000):
    habitat_config = habitat.get_config(path)
    with read_write(habitat_config):
        habitat_config.habitat.dataset.split = stage
        habitat_config.habitat.dataset.scenes_dir = SCENE_PREFIX
